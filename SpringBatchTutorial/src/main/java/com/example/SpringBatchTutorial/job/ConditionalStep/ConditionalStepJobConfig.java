    ...
    public Job conditionalStepJob(
        ...
        return jobBuilderFactory.get("conditionalStepJob")
                ...
                .start(conditionalStartStep)
                    .on("FAILED").to(conditionalFailStep)/*실패한 경우*/
                .from(conditionalStartStep)
                    .on("COMPLETED").to(conditionalCompletedStep)/*성공한 경우*/
                .from(conditionalStartStep)
                    .on("*").to(conditionalAllStep)/*실패,성공이 아닌 또 다른 경우*/
                .end()
